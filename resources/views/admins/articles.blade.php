                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row grid-margin mb-2">
                            ...
                            <div class="col-12">
                                <a class="btn btn-light btn-with-icon btn-block" href="{{ route('articles.create') }}">
                                    <i class="typcn typcn-document-add text-success"></i> @lang('locale.add', ['param'=>__('locale.article', ['prefix'=>'', 'suffix'=>''])])
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <table cellspacing="0" class="table" id="order-listing" width="100%">
                                    <thead>
                                        ...
                                        <th>@lang('locale.category', ['prefix'=>'', 'suffix'=>app()->getLocale() == 'en' ? 'y' : ''])</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div style="display: inline-block">
                                                    <a class="btn btn-light" href="{{ route('articles.edit', $item->id) }}">
                                                        <i class="typcn icon typcn-edit text-primary"></i>
                                                    </a>
                                                    <a class="btn btn-light" href="{{ route('articles.show', $item->id) }}">
                                                        <i class="typcn icon typcn-eye text-secondary"></i>
                                                    </a>
                                                </div>
                                                <form action="{{ route('articles.destroy', $item->id) }}" style="display: inline-block" method="post">
                                                    @csrf
                                                    @method('DELETE')
