                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="name" placeholder="@lang('locale.name')" type="text" name="name" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="price">@lang('locale.price') <span class="text-danger">*</span></label>
                                            <input class="form-control" id="price" placeholder="@lang('locale.price')" type="number" name="price" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="brand">@lang('locale.brand') <span class="text-danger">*</span></label>
                                            <input class="form-control" id="brand" placeholder="@lang('locale.brand')" type="text" name="brand" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="qty">@lang('locale.quantity', ['prefix'=>'', 'suffix'=>(app()->getLocale() == 'en' ? 'y' : 'e')]) <span class="text-danger">*</span></label>
                                            <input class="form-control" id="qty" placeholder="@lang('locale.quantity', ['prefix'=>'', 'suffix'=>(app()->getLocale() == 'en' ? 'y' : '')])" type="number" name="qty" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-12">
                                        <div class="form-group">
